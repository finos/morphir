...
cmd diagnostics display_order=8 subcommand_required=#true arg_required_else_help=#true args_override_self=#false help="Locate Morphir logs and collect troubleshooting information" unknown_flags=error {
