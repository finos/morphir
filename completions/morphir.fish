...
cmd playground display_order=8 args_override_self=#false help="Open a scratch Morphir Playground in a browser, with no workspace required" unknown_flags=error {
    flag --no-open help="Print the one-time launch URL instead of opening a browser"
}
cmd config display_order=9 subcommand_required=#true arg_required_else_help=#true args_override_self=#false help="Inspect the effective Morphir configuration" unknown_flags=error {
...
cmd diagnostics display_order=10 subcommand_required=#true arg_required_else_help=#true args_override_self=#false help="Locate Morphir logs and collect troubleshooting information" unknown_flags=error {
...
cmd cache display_order=11 subcommand_required=#true arg_required_else_help=#true args_override_self=#false help="Inspect and clean disposable Morphir caches" unknown_flags=error {
...
cmd tool display_order=12 subcommand_required=#true arg_required_else_help=#true args_override_self=#false help="Manage CLI-installed Morphir tools" unknown_flags=error {
...
cmd dist display_order=13 subcommand_required=#true arg_required_else_help=#true args_override_self=#false help="Manage Morphir distributions" unknown_flags=error {
...
cmd extension display_order=14 subcommand_required=#true arg_required_else_help=#true args_override_self=#false help="Manage Morphir extensions" unknown_flags=error {
...
cmd ir display_order=15 subcommand_required=#true arg_required_else_help=#true args_override_self=#false help="Manage Morphir IR" unknown_flags=error {
...
cmd kb display_order=16 subcommand_required=#true arg_required_else_help=#true args_override_self=#false help="Manage the knowledge base under kb/ — OKF bundles and concept documents" unknown_flags=error {
...
cmd gleam display_order=17 subcommand_required=#true arg_required_else_help=#true args_override_self=#false help="Gleam language binding commands" unknown_flags=error {
    flag --json help="Output as JSON"
    flag --json-lines help="Output as JSON Lines (streaming)"
...
cmd schema display_order=18 args_override_self=#false help="Generate JSON Schema for Morphir IR" unknown_flags=error {
    flag "-o --output" help="Output file path (optional)" {
        arg <OUTPUT>
    }
    complete output type=path
}
cmd version display_order=19 args_override_self=#false help="Print version information" unknown_flags=error {
    flag --json help="Output version info as JSON"
}
cmd usage hide=#true display_order=20 args_override_self=#false help="Output usage spec for documentation generation" unknown_flags=error
'
