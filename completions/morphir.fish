...
cmd itest display_order=4 args_override_self=#false help="Run notebook integration scenarios through real CLI processes" unknown_flags=error {
    flag --filter help="Select one example path or category relative to the search root" {
        arg <FILTER>
    }
    ...
    arg "[ROOT]" help="Directory to search recursively for scenario.ipynb files" required=#false default=examples
...
cmd gleam display_order=21 subcommand_required=#true arg_required_else_help=#true args_override_self=#false help="Gleam language binding commands" unknown_flags=error {
    flag --json help="Output as JSON"
    flag --json-lines help="Output as JSON Lines (streaming)"
...
cmd schema display_order=22 args_override_self=#false help="Generate JSON Schema for Morphir IR" unknown_flags=error {
    flag "-o --output" help="Output file path (optional)" {
        arg <OUTPUT>
    }
    complete output type=path
}
cmd version display_order=23 args_override_self=#false help="Print version information" unknown_flags=error {
    flag --json help="Output version info as JSON"
}
cmd usage hide=#true display_order=24 args_override_self=#false help="Output usage spec for documentation generation" unknown_flags=error
'
