...
cmd compile display_order=2 args_override_self=#false help="Compile source code to Morphir IR" unknown_flags=error {
    ...
    flag "-i --input" help="Input source directory or file. A configured Elm process accepts one .elm file" {
        arg <INPUT>
    }
    ...
    flag --config help="Explicit config file path. Elm process commands come from [extensions.morphir-elm]" {
        arg <CONFIG>
    }
