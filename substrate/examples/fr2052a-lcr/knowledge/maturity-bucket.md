# Maturity Bucket [Choice](../../substrate/language/concepts/choice.md)
...
- **Range** — a contiguous, inclusive range of days to maturity.
  - `from_days` — [Integer](../../substrate/language/expressions/integer.md),
    required. Lower bound, inclusive.
  - `to_days` — [Integer](../../substrate/language/expressions/integer.md),
...
[match]: ../../substrate/language/concepts/choice.md#match-operation
