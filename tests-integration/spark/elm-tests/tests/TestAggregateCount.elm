...
module TestAggregateCount exposing (..)
...
import SparkTests.AggregationTests exposing (testAggregateCount)
...
encodeResult : List { product : Product, count : Float } -> String
...
testAggregate : Test
testAggregate =
    executeTest "testAggregateCount" antiquesDataSource testAggregateCount encodeResult
