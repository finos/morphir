...
{-
   ...
   lawOfGravitation5 : Float -> Float -> Float -> Float -> Float -> Float -> Float -> Float -> Float
   lawOfGravitation5 f1 f2 f3 f4 f5 f8 f9 f10 =
       f1 + (f2 * f5 * f8 * f9 * f10) / f3 * f4
...
lawOfGravitation10 : Float -> Float -> Float -> Float -> Float -> Float
lawOfGravitation10 g m1 m2 m6 r =
    g * m1 * m2 * m6 / r * r
