...
class ReleaseWorkflowTests(unittest.TestCase):
    ...
    def test_workspace_uses_release_prerelease_version(self) -> None:
        ...
        self.assertEqual("0.4.0-alpha.7", workspace["workspace"]["package"]["version"])
    ...
    def test_ci_requires_only_the_cli_rust_job(self) -> None:
        ...
        self.assertIn(
            "needs: [changes, lint, build-elm-extension, build-scala-extension, morphir-cli-test, check-cli-docs, docs, rust-conformance, release-workflow, desktop-demo, package-mck]",
            self.ci_workflow,
        )
        self.assertNotIn(
