...
var $author$project$Morphir$Web$Insight$FunctionArgumentsSet = F4(
	function (a, b, c, d) {
		return {$: 'FunctionArgumentsSet', a: a, b: b, c: c, d: d};
	});
var $author$project$Morphir$Web$Insight$FunctionNameSet = F3(
	function (a, b, c) {
		return {$: 'FunctionNameSet', a: a, b: b, c: c};
	});
...
var $author$project$Morphir$Web$Insight$update = F2(
	function (msg, model) {
		...
		if (msg.$ === 'FunctionArgumentsReceived') {
			var jsonList = msg.a;
			var jsonDecoder = $elm$json$Json$Decode$list(
				A2(
					...
					$elm$json$Json$Decode$succeed(_Utils_Tuple0),
					$elm$json$Json$Decode$succeed(_Utils_Tuple0)));
			var _v1 = A2($elm$json$Json$Decode$decodeValue, jsonDecoder, jsonList);
			if (_v1.$ === 'Ok') {
				var updatedArgValues = _v1.a;
				switch (model.$) {
					case 'FunctionNameSet':
						var distribution = model.a;
						var qName = model.b;
						...
						return _Utils_Tuple2(
							A4($author$project$Morphir$Web$Insight$FunctionArgumentsSet, distribution, qName, valueDef, updatedArgValues),
				...
				return _Utils_Tuple2(
					$author$project$Morphir$Web$Insight$Failed('Received Arguments Cannot Decode'),
					$elm$core$Platform$Cmd$none);
			}
		} else {
			var qNameString = msg.a;
			var _v3 = $author$project$Morphir$IR$QName$fromString(qNameString);
			if (_v3.$ === 'Just') {
				var qName = _v3.a;
				return A2(
					$elm$core$Maybe$withDefault,
						...
						A2(
							...
							function (distribution) {
								return A2(
									$elm$core$Maybe$map,
									function (valueDef) {
										return A3($author$project$Morphir$Web$Insight$FunctionNameSet, distribution, qName, valueDef);
									},
				...
				return _Utils_Tuple2(
					$author$project$Morphir$Web$Insight$Failed('Function Name Received is Not correct'),
					$elm$core$Platform$Cmd$none);
			}
		}
	});
...
var $author$project$Morphir$Visual$ViewValue$viewWithData = F3(
	function (distribution, valueDef, argumentValues) {
		var indexedValue = A3(
			$author$project$Morphir$IR$Value$indexedMapValue,
			F2(
				function (index, va) {
	...
	switch (model.$) {
		...
		case 'FunctionNameSet':
			...
			return A2(
				...
				_List_Nil,
				$author$project$Morphir$Visual$ViewValue$view(valueDef.body));
		default:
			var distribution = model.a;
			var qName = model.b;
			var valueDef = model.c;
			...
			return A2(
				...
				_List_Nil,
				A3(
					$author$project$Morphir$Visual$ViewValue$viewWithData,
					distribution,
					valueDef,
					$elm$core$Dict$fromList(
						A3(
