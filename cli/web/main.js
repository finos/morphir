...
var $author$project$Morphir$IR$Distribution$Codec$decodeDistribution = A2(
	...
	A2($elm$json$Json$Decode$index, 0, $elm$json$Json$Decode$string));
var $author$project$Morphir$Elm$CLI$FrontendError = function (a) {
	return {$: 'FrontendError', a: a};
};
var $author$project$Morphir$Elm$CLI$TypeError = function (a) {
	return {$: 'TypeError', a: a};
};
var $author$project$Morphir$Type$Infer$TypeErrors = function (a) {
	return {$: 'TypeErrors', a: a};
};
var $author$project$Morphir$Type$Infer$ValueTypeError = F2(
	function (a, b) {
		return {$: 'ValueTypeError', a: a, b: b};
	});
var $author$project$Morphir$Type$Infer$Codec$decodeValueTypeError = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Morphir$Type$Infer$ValueTypeError,
	A2($elm$json$Json$Decode$index, 1, $author$project$Morphir$IR$Name$Codec$decodeName),
	$elm$json$Json$Decode$succeed(
		$author$project$Morphir$Type$Infer$TypeErrors(_List_Nil)));
var $author$project$Morphir$Elm$CLI$decodeError = A2(
	$elm$json$Json$Decode$andThen,
	function (tag) {
		switch (tag) {
			case 'frontend_error':
				return A2(
					$elm$json$Json$Decode$map,
					$author$project$Morphir$Elm$CLI$FrontendError,
					A2(
						$elm$json$Json$Decode$index,
						1,
			...
			case 'type_error':
				return A2(
					$elm$json$Json$Decode$map,
					$author$project$Morphir$Elm$CLI$TypeError,
					A2(
						$elm$json$Json$Decode$index,
						1,
						$elm$json$Json$Decode$list($author$project$Morphir$Type$Infer$Codec$decodeValueTypeError)));
			default:
				var other = tag;
		...
		switch (tag) {
			...
			case 'err':
				return A2(
					$elm$json$Json$Decode$map,
					$elm$core$Result$Err,
					A2($elm$json$Json$Decode$index, 1, $author$project$Morphir$Elm$CLI$decodeError));
			default:
				var other = tag;
...
var $author$project$Morphir$Graph$GraphVizBackend$valueToLabel = function (indexedValue) {
	switch (indexedValue.$) {
		case 'Literal':
		...
		case 'Variable':
			...
			return $elm$core$String$concat(name);
		case 'Apply':
			var fun = indexedValue.b;
			var arg = indexedValue.c;
			var _v2 = A2($author$project$Morphir$IR$Value$uncurryApply, fun, arg);
			if (((((((((((((((((_v2.a.$ === 'Reference') && _v2.a.b.a.b) && _v2.a.b.a.a.b) && (_v2.a.b.a.a.a === 'morphir')) && (!_v2.a.b.a.a.b.b)) && _v2.a.b.a.b.b) && _v2.a.b.a.b.a.b) && (_v2.a.b.a.b.a.a === 's')) && _v2.a.b.a.b.a.b.b) && (_v2.a.b.a.b.a.b.a === 'd')) && _v2.a.b.a.b.a.b.b.b) && (_v2.a.b.a.b.a.b.b.a === 'k')) && (!_v2.a.b.a.b.a.b.b.b.b)) && (!_v2.a.b.a.b.b.b)) && _v2.b.b) && _v2.b.b.b) && (!_v2.b.b.b.b)) {
				var _v3 = _v2.a;
				var _v4 = _v3.b;
				var _v5 = _v4.a;
				var _v6 = _v5.a;
				...
				var localName = _v4.c;
				var _v11 = _v2.b;
				var argValue1 = _v11.a;
				var _v12 = _v11.b;
				var argValue2 = _v12.a;
				var functionName = A2(
					$elm$core$String$join,
					'.',
					_List_fromArray(
				...
				return $elm$core$String$concat(
					_List_fromArray(
						[
							$author$project$Morphir$Graph$GraphVizBackend$valueToLabel(argValue1),
							' ',
							operatorName,
							' ',
							$author$project$Morphir$Graph$GraphVizBackend$valueToLabel(argValue2)
						]));
			} else {
				return '?';
			}
...
var $author$project$Morphir$Graph$GraphVizBackend$valueNodes = function (indexedValue) {
	if (indexedValue.$ === 'IfThenElse') {
		var _v1 = indexedValue.a;
		var index = _v1.a;
		...
		var conditionNode = A2(
			...
			_List_fromArray(
				[
					...
					'label',
					$author$project$Morphir$Graph$GraphVizBackend$valueToLabel(condition)),
		...
		return $elm$core$List$concat(
			_List_fromArray(
				[
					_List_fromArray(
					[conditionNode]),
					$author$project$Morphir$Graph$GraphVizBackend$valueNodes(thenBranch),
					$author$project$Morphir$Graph$GraphVizBackend$valueNodes(elseBranch)
				]));
	} else {
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Morphir$Graph$GraphViz$AST$Attribute,
						'label',
						$author$project$Morphir$Graph$GraphVizBackend$valueToLabel(indexedValue)),
						A2($author$project$Morphir$Graph$GraphViz$AST$Attribute, 'shape', 'box')
					]))
			]);
	}
};
var $author$project$Morphir$Graph$GraphVizBackend$mapValue = function (indexedValue) {
	if (indexedValue.$ === 'IfThenElse') {
		var _v1 = indexedValue.a;
		var index = _v1.a;
		return $elm$core$Maybe$Just(
			A2(
				...
				$elm$core$List$concat(
					_List_fromArray(
						[
							$author$project$Morphir$Graph$GraphVizBackend$valueNodes(indexedValue),
...
var $author$project$Morphir$Visual$ViewIfThenElse$view = F2(
	function (viewValue, value) {
		var _v0 = $author$project$Morphir$Graph$GraphVizBackend$mapValue(value);
		if (_v0.$ === 'Just') {
			var graph = _v0.a;
...
var $author$project$Morphir$Visual$ViewList$view = F3(
	function (viewValue, itemType, items) {
		if (itemType.$ === 'Record') {
...
var $author$project$Morphir$Visual$ViewValue$view = function (value) {
	var indexedValue = A3(
		$author$project$Morphir$IR$Value$indexedMapValue,
		F2(
			function (index, va) {
				return _Utils_Tuple2(index, va);
			}),
		0,
		value).a;
	_v0$9:
	while (true) {
		switch (value.$) {
			...
			case 'Tuple':
				var tpe = value.a;
				var elems = value.b;
				return A2($author$project$Morphir$Visual$ViewTuple$view, $author$project$Morphir$Visual$ViewValue$view, elems);
			case 'List':
				if ((((((((((((((((((((((((value.a.$ === 'Reference') && value.a.b.a.b) && value.a.b.a.a.b) && (value.a.b.a.a.a === 'morphir')) && (!value.a.b.a.a.b.b)) && value.a.b.a.b.b) && value.a.b.a.b.a.b) && (value.a.b.a.b.a.a === 's')) && value.a.b.a.b.a.b.b) && (value.a.b.a.b.a.b.a === 'd')) && value.a.b.a.b.a.b.b.b) && (value.a.b.a.b.a.b.b.a === 'k')) && (!value.a.b.a.b.a.b.b.b.b)) && (!value.a.b.a.b.b.b)) && value.a.b.b.b) && value.a.b.b.a.b) && (value.a.b.b.a.a === 'list')) && (!value.a.b.b.a.b.b)) && (!value.a.b.b.b.b)) && value.a.b.c.b) && (value.a.b.c.a === 'list')) && (!value.a.b.c.b.b)) && value.a.c.b) && (!value.a.c.b.b)) {
					...
					var itemType = _v12.a;
					var items = value.b;
					return A3($author$project$Morphir$Visual$ViewList$view, $author$project$Morphir$Visual$ViewValue$view, itemType, items);
				} else {
					break _v0$9;
				}
			case 'Variable':
			...
			case 'Reference':
				var tpe = value.a;
				var fQName = value.b;
				return A2($author$project$Morphir$Visual$ViewReference$view, $author$project$Morphir$Visual$ViewValue$view, fQName);
			case 'Field':
				var tpe = value.a;
				var subjectValue = value.b;
				var fieldName = value.c;
				return A3($author$project$Morphir$Visual$ViewField$view, $author$project$Morphir$Visual$ViewValue$view, subjectValue, fieldName);
			case 'Apply':
				var fun = value.b;
				var arg = value.c;
				var _v13 = A2($author$project$Morphir$IR$Value$uncurryApply, fun, arg);
				var _function = _v13.a;
				var argsReversed = _v13.b;
				return A3(
					$author$project$Morphir$Visual$ViewApply$view,
					$author$project$Morphir$Visual$ViewValue$view,
					_function,
					$elm$core$List$reverse(argsReversed));
			case 'LetDefinition':
				var tpe = value.a;
			...
			case 'IfThenElse':
				return A2($author$project$Morphir$Visual$ViewIfThenElse$view, $author$project$Morphir$Visual$ViewValue$view, indexedValue);
			default:
				break _v0$9;
		}
	}
...
var $author$project$Morphir$Web$DevelopMain$viewModule = function (accessControlledModuleDef) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
					...
					A2(
						...
						_List_fromArray(
							[
								...
								A2(
									$author$project$Morphir$Web$DevelopMain$theme.heading,
									3,
									A2(
										$elm$core$String$join,
										' ',
										$author$project$Morphir$IR$Name$toHumanWords(valueName)))),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[
								...
								$author$project$Morphir$Visual$ViewValue$view(accessControlledValueDef.value.body))
							])));
			},
			$elm$core$Dict$toList(accessControlledModuleDef.value.values)));
};
var $author$project$Morphir$Web$DevelopMain$viewDistribution = function (distro) {
	...
	return A2(
		...
		_List_fromArray(
			[
				A2($author$project$Morphir$Web$DevelopMain$theme.heading, 1, 'Package'),
				$mdgriffith$elm_ui$Element$text(
				A2(
					$elm$core$String$join,
					' / ',
					A2(
						...
						A2(
							...
							$elm$core$String$join(' ')),
						$author$project$Morphir$IR$Path$toList(packageName)))),
				A2($author$project$Morphir$Web$DevelopMain$theme.heading, 1, 'Modules'),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
									...
									A2(
										...
										A2(
											...
											A2(
												...
												$author$project$Morphir$IR$Name$toHumanWords,
												$elm$core$String$join(' ')),
											$author$project$Morphir$IR$Path$toList(moduleName)))),
									$author$project$Morphir$Web$DevelopMain$viewModule(moduleDef)
								]));
					},
	...
	switch (model.$) {
		...
		default:
			...
			if (distributionResult.$ === 'Ok') {
				...
				return $author$project$Morphir$Web$DevelopMain$viewDistribution(distribution);
			} else {
