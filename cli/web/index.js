...
var $author$project$Morphir$Web$DevelopApp$LinkClicked = function (a) {
	return {$: 'LinkClicked', a: a};
};
var $author$project$Morphir$Web$DevelopApp$UrlChanged = function (a) {
...
var $author$project$Morphir$Web$DevelopApp$IRLoading = {$: 'IRLoading'};
var $author$project$Morphir$Web$DevelopApp$ModulePage$InsightView = {$: 'InsightView'};
var $author$project$Morphir$Visual$Config$PopupScreenRecord = F2(
	function (variableIndex, variableValue) {
		return {variableIndex: variableIndex, variableValue: variableValue};
	});
var $author$project$Morphir$Web$DevelopApp$ServerReady = {$: 'ServerReady'};
...
var $author$project$Morphir$Web$DevelopApp$ServerGetIRResponse = function (a) {
	return {$: 'ServerGetIRResponse', a: a};
};
...
var $author$project$Morphir$Web$DevelopApp$httpMakeModel = $elm$http$Http$get(
	{
		expect: A2(
...
var $author$project$Morphir$Web$DevelopApp$FilterState = F3(
	function (searchText, showValues, showTypes) {
		return {searchText: searchText, showTypes: showTypes, showValues: showValues};
	});
...
var $author$project$Morphir$Web$DevelopApp$queryParams = function () {
	var trueOrFalse = $elm$core$Dict$fromList(
		_List_fromArray(
			[
	...
	var showValues = A2(
		...
		A2($elm$url$Url$Parser$Query$enum, 'showValues', trueOrFalse));
	var showTypes = A2(
		$elm$url$Url$Parser$Query$map,
		$elm$core$Maybe$withDefault(true),
		A2($elm$url$Url$Parser$Query$enum, 'showTypes', trueOrFalse));
	var search = A2(
		$elm$url$Url$Parser$Query$map,
		$elm$core$Maybe$withDefault(''),
		$elm$url$Url$Parser$Query$string('search'));
	return A4($elm$url$Url$Parser$Query$map3, $author$project$Morphir$Web$DevelopApp$FilterState, search, showValues, showTypes);
}();
...
var $author$project$Morphir$Web$DevelopApp$Type = function (a) {
	return {$: 'Type', a: a};
};
var $author$project$Morphir$Web$DevelopApp$Value = function (a) {
	return {$: 'Value', a: a};
};
...
var $author$project$Morphir$Web$DevelopApp$Common$urlFragmentToNodePath = function (f) {
	var makeNodePath = F2(
		function (s, l) {
			makeNodePath:
			while (true) {
				if (s === '') {
					...
					var $temp$s = A2(
						...
						_List_fromArray(
							[
								$author$project$Morphir$IR$Path$fromString(s)
							]));
					s = $temp$s;
					l = $temp$l;
					continue makeNodePath;
				}
			}
		});
	return A2(makeNodePath, f, _List_Nil);
};
var $author$project$Morphir$Web$DevelopApp$updateHomeState = F4(
	function (pack, mod, def, filterState) {
		var updateModel = F2(
		...
		var toTypeOrValue = F2(
			function (m, d) {
				var _v0 = $elm$core$String$uncons(d);
				if (_v0.$ === 'Just') {
					var _v1 = _v0.a;
					var first = _v1.a;
					return $elm$core$Char$isLower(first) ? $elm$core$Maybe$Just(
						$author$project$Morphir$Web$DevelopApp$Value(
							_Utils_Tuple2(
								$author$project$Morphir$IR$Path$fromString(m),
								$author$project$Morphir$IR$Name$fromString(d)))) : $elm$core$Maybe$Just(
						$author$project$Morphir$Web$DevelopApp$Type(
							_Utils_Tuple2(
								$author$project$Morphir$IR$Path$fromString(m),
								$author$project$Morphir$IR$Name$fromString(d))));
				} else {
					return $elm$core$Maybe$Nothing;
				}
			});
		return (pack === '') ? updateModel(
			{filterState: filterState, selectedDefinition: $elm$core$Maybe$Nothing, selectedModule: $elm$core$Maybe$Nothing, selectedPackage: $elm$core$Maybe$Nothing}) : ((mod === '') ? updateModel(
			{
				filterState: filterState,
				selectedDefinition: $elm$core$Maybe$Nothing,
				selectedModule: $elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Morphir$Web$DevelopApp$Common$urlFragmentToNodePath(mod),
						_List_Nil)),
				selectedPackage: $elm$core$Maybe$Just(
					$author$project$Morphir$IR$Path$fromString(pack))
			}) : updateModel(
			{
				filterState: filterState,
				selectedDefinition: A3(
					$author$project$Morphir$Web$DevelopApp$Common$ifThenElse,
					def === '',
					$elm$core$Maybe$Nothing,
					A2(toTypeOrValue, mod, def)),
				selectedModule: $elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Morphir$Web$DevelopApp$Common$urlFragmentToNodePath(mod),
						$author$project$Morphir$IR$Path$fromString(mod))),
				selectedPackage: $elm$core$Maybe$Just(
					$author$project$Morphir$IR$Path$fromString(pack))
			}));
	});
var $author$project$Morphir$Web$DevelopApp$definitionUrl = A2(
	$elm$url$Url$Parser$map,
	$author$project$Morphir$Web$DevelopApp$updateHomeState,
	A2(
		$elm$url$Url$Parser$slash,
		...
		A2(
			...
			A2(
				$elm$url$Url$Parser$slash,
				$elm$url$Url$Parser$string,
				A2($elm$url$Url$Parser$questionMark, $elm$url$Url$Parser$string, $author$project$Morphir$Web$DevelopApp$queryParams)))));
var $author$project$Morphir$Web$DevelopApp$moduleUrl = A2(
	$elm$url$Url$Parser$map,
	F3(
		function (pack, mod, filter) {
			return A4($author$project$Morphir$Web$DevelopApp$updateHomeState, pack, mod, '', filter);
		}),
	A2(
		$elm$url$Url$Parser$slash,
		$elm$url$Url$Parser$s('home'),
...
var $author$project$Morphir$Web$DevelopApp$packageUrl = A2(
	$elm$url$Url$Parser$map,
	F2(
		function (pack, filter) {
			return A4($author$project$Morphir$Web$DevelopApp$updateHomeState, pack, '', '', filter);
		}),
	A2(
		$elm$url$Url$Parser$slash,
		$elm$url$Url$Parser$s('home'),
		A2($elm$url$Url$Parser$questionMark, $elm$url$Url$Parser$string, $author$project$Morphir$Web$DevelopApp$queryParams)));
var $author$project$Morphir$Web$DevelopApp$topUrl = $elm$url$Url$Parser$map(
	function (filter) {
		return A4($author$project$Morphir$Web$DevelopApp$updateHomeState, '', '', '', filter);
	});
var $author$project$Morphir$Web$DevelopApp$topUrlWithHome = $author$project$Morphir$Web$DevelopApp$topUrl(
	A2(
		$elm$url$Url$Parser$questionMark,
		$elm$url$Url$Parser$s('home'),
		$author$project$Morphir$Web$DevelopApp$queryParams));
var $elm$url$Url$Parser$top = $elm$url$Url$Parser$Parser(
	function (state) {
		return _List_fromArray(
			[state]);
	});
var $author$project$Morphir$Web$DevelopApp$topUrlWithoutHome = $author$project$Morphir$Web$DevelopApp$topUrl(
	A2($elm$url$Url$Parser$questionMark, $elm$url$Url$Parser$top, $author$project$Morphir$Web$DevelopApp$queryParams));
var $author$project$Morphir$Web$DevelopApp$routeParser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[$author$project$Morphir$Web$DevelopApp$topUrlWithoutHome, $author$project$Morphir$Web$DevelopApp$topUrlWithHome, $author$project$Morphir$Web$DevelopApp$packageUrl, $author$project$Morphir$Web$DevelopApp$moduleUrl, $author$project$Morphir$Web$DevelopApp$definitionUrl]));
var $author$project$Morphir$Web$DevelopApp$toRoute = function (url) {
	return A2(
		$elm$core$Maybe$withDefault,
		$elm$core$Basics$identity,
		A2($elm$url$Url$Parser$parse, $author$project$Morphir$Web$DevelopApp$routeParser, url));
};
var $author$project$Morphir$Web$DevelopApp$init = F3(
	function (_v0, url, key) {
		var initModel = {
			collapsedModules: $elm$core$Set$empty,
			functionStates: $elm$core$Dict$empty,
			homeState: {
				filterState: {searchText: '', showTypes: true, showValues: true},
				selectedDefinition: $elm$core$Maybe$Nothing,
				selectedModule: $elm$core$Maybe$Nothing,
				selectedPackage: $elm$core$Maybe$Nothing
			},
			irState: $author$project$Morphir$Web$DevelopApp$IRLoading,
			key: key,
			repo: $author$project$Morphir$IR$Repo$empty(_List_Nil),
			serverState: $author$project$Morphir$Web$DevelopApp$ServerReady,
			showModules: true,
			simpleDefinitionDetailsModel: {
				argState: $elm$core$Dict$empty,
				expandedValues: $elm$core$Dict$empty,
				filter: $elm$core$Maybe$Just(''),
				moduleName: _List_Nil,
				popupVariables: A2($author$project$Morphir$Visual$Config$PopupScreenRecord, 0, $elm$core$Maybe$Nothing),
				showSearchBar: false,
				viewType: $author$project$Morphir$Web$DevelopApp$ModulePage$InsightView
			},
			testSuite: $elm$core$Dict$empty,
			theme: $author$project$Morphir$Visual$Theme$fromConfig($elm$core$Maybe$Nothing)
		};
		return _Utils_Tuple2(
			A2($author$project$Morphir$Web$DevelopApp$toRoute, url, initModel),
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[$author$project$Morphir$Web$DevelopApp$httpMakeModel])));
	});
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Morphir$Web$DevelopApp$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Morphir$Web$DevelopApp$IRLoaded = function (a) {
	return {$: 'IRLoaded', a: a};
};
var $author$project$Morphir$Web$DevelopApp$ServerHttpError = function (a) {
	return {$: 'ServerHttpError', a: a};
};
var $author$project$Morphir$IR$Package$emptyDefinition = {modules: $elm$core$Dict$empty};
var $author$project$Morphir$Web$DevelopApp$filterStateToQueryParams = function (filterState) {
	var search = A3($author$project$Morphir$Web$DevelopApp$Common$ifThenElse, filterState.searchText === '', '', '&search=' + filterState.searchText);
	var filterValues = A3($author$project$Morphir$Web$DevelopApp$Common$ifThenElse, filterState.showValues, '', '&showValues=false');
	var filterTypes = A3($author$project$Morphir$Web$DevelopApp$Common$ifThenElse, filterState.showTypes, '', '&showTypes=false');
	return '?' + (search + (filterValues + filterTypes));
};
...
var $author$project$Morphir$IR$Repo$insertModule = F3(
	function (moduleName, moduleDef, _v0) {
		var repo = _v0.a;
		var validationErrors = function () {
			var _v15 = A2($elm$core$Dict$get, moduleName, repo.modules);
			if (_v15.$ === 'Just') {
				return $elm$core$Maybe$Just(
					_List_fromArray(
						[
		...
		var allValuesInModule = A2(
			...
			function (_v14) {
				var name = _v14.a;
				var accessControlledValueDef = _v14.b;
				return _Utils_Tuple2(
					A3(
						$author$project$Morphir$IR$FQName$fQName,
		...
		var updateRepoValueDependencies = function (_v13) {
			var r = _v13.a;
			return A2(
				$elm$core$Result$map,
				function (valueDag) {
				...
				A3(
					$elm$core$List$foldl,
					F2(
						function (_v10, dagResultSoFar) {
							var valueFQN = _v10.a;
							var valueDeps = _v10.b;
							return A2(
								$elm$core$Result$andThen,
								A2(
									...
									$elm$core$Result$mapError(
										function (_v11) {
											...
											return _List_fromArray(
												[
													$author$project$Morphir$IR$Repo$ValueCycleDetected(n)
												]);
										})),
								dagResultSoFar);
						}),
		...
		var allTypesInModule = A2(
			...
			function (_v9) {
				var name = _v9.a;
				var accessControlledTypeDef = _v9.b;
				return _Utils_Tuple2(
					A3(
						$author$project$Morphir$IR$FQName$fQName,
						$author$project$Morphir$IR$Repo$getPackageName(
		...
		var updateRepoModulesDependencies = function (_v8) {
			var r = _v8.a;
			return A2(
				$elm$core$Result$map,
				function (updatedModuleDependencies) {
					return $author$project$Morphir$IR$Repo$Repo(
						_Utils_update(
							r,
							{moduleDependencies: updatedModuleDependencies}));
				},
				A2(
					$elm$core$Result$mapError,
					A2($elm$core$Basics$composeR, $author$project$Morphir$IR$Repo$ModuleCycleDetected, $elm$core$List$singleton),
					function (dependencies) {
						return A3($author$project$Morphir$Dependency$DAG$insertNode, moduleName, dependencies, r.moduleDependencies);
					}(
						A2(
							$elm$core$Set$filter,
							function (modName) {
								return !_Utils_eq(modName, moduleName);
							},
		...
		var updateRepoTypeDependencies = function (_v5) {
			var r = _v5.a;
			return A2(
				$elm$core$Result$map,
				function (typeDAG) {
								...
								A2(
									...
									$elm$core$Result$mapError(
										function (_v3) {
											...
											return _List_fromArray(
												[
													$author$project$Morphir$IR$Repo$TypeCycleDetected(n)
												]);
										})),
								dagResultSoFar);
						}),
	...
	return A2(
		...
		A2(
			...
			function (err) {
				return _List_fromArray(
					[
						$author$project$Morphir$IR$Repo$ModuleCycleDetected(err)
					]);
			},
			A2($author$project$Morphir$IR$Package$modulesOrderedByDependency, packageName, packageDef)));
};
var $author$project$Morphir$Web$DevelopApp$ServerGetTestsResponse = function (a) {
	return {$: 'ServerGetTestsResponse', a: a};
};
			...
			expect: A2(
				...
				function (response) {
					if (response.$ === 'Err') {
						...
						var result = response.a;
						return $author$project$Morphir$Web$DevelopApp$ServerGetTestsResponse(result);
					}
				},
...
var $author$project$Morphir$Web$DevelopApp$update = F2(
	function (msg, model) {
		var getDistribution = function () {
			var _v4 = model.irState;
			if (_v4.$ === 'IRLoaded') {
				var distribution = _v4.a;
				return distribution;
			} else {
		...
		var getIR = $author$project$Morphir$IR$fromDistribution(getDistribution);
			...
			case 'UrlChanged':
				...
				return _Utils_Tuple2(
					A2(
						$elm$core$Debug$log,
						'urlChanged',
						A2($author$project$Morphir$Web$DevelopApp$toRoute, url, model)),
					$elm$core$Platform$Cmd$none);
			case 'HttpError':
				var httpError = _v0.a;
				var _v2 = model.irState;
				if (_v2.$ === 'IRLoaded') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								serverState: $author$project$Morphir$Web$DevelopApp$ServerHttpError(httpError)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'ServerGetIRResponse':
				var distribution = _v0.a;
				var _v3 = $author$project$Morphir$IR$Repo$fromDistribution(distribution);
				if (_v3.$ === 'Ok') {
					var r = _v3.a;
					return _Utils_Tuple2(
						_Utils_update(
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								irState: $author$project$Morphir$Web$DevelopApp$IRLoaded(distribution),
								serverState: $author$project$Morphir$Web$DevelopApp$ServerHttpError(
			...
			case 'ExpandModule':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							collapsedModules: A2($elm$core$Set$remove, nodePath, model.collapsedModules)
						}),
					$elm$core$Platform$Cmd$none);
			case 'CollapseModule':
				var nodePath = _v0.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							collapsedModules: A2($elm$core$Set$insert, nodePath, model.collapsedModules)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleModulesMenu':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{showModules: !model.showModules}),
					$elm$core$Platform$Cmd$none);
			case 'SearchDefinition':
				var s = _v0.a;
				var homeState = model.homeState;
				var filterState = homeState.filterState;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							homeState: _Utils_update(
								homeState,
								{
									filterState: _Utils_update(
										filterState,
										{searchText: s})
								})
						}),
					A2(
						...
						model.key,
						$author$project$Morphir$Web$DevelopApp$filterStateToQueryParams(
							_Utils_update(
								filterState,
								{searchText: s}))));
			case 'ToggleValues':
				var v = _v0.a;
				var filterState = model.homeState.filterState;
				return _Utils_Tuple2(
					model,
					A2(
						$elm$browser$Browser$Navigation$replaceUrl,
...
var $author$project$Morphir$Web$DevelopApp$CollapseModule = function (a) {
	return {$: 'CollapseModule', a: a};
};
var $author$project$Morphir$Web$DevelopApp$ExpandModule = function (a) {
	return {$: 'ExpandModule', a: a};
};
var $author$project$Morphir$Web$DevelopApp$SearchDefinition = function (a) {
	return {$: 'SearchDefinition', a: a};
};
var $author$project$Morphir$Web$DevelopApp$ToggleModulesMenu = {$: 'ToggleModulesMenu'};
var $author$project$Morphir$Web$DevelopApp$ToggleTypes = function (a) {
	return {$: 'ToggleTypes', a: a};
};
var $author$project$Morphir$Web$DevelopApp$ToggleValues = function (a) {
	return {$: 'ToggleValues', a: a};
};
...
var $author$project$Morphir$Visual$Theme$defaultClickableListElem = F2(
	function (theme, elem) {
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Border$color(theme.colors.lightest),
					$mdgriffith$elm_ui$Element$Border$widthEach(
					{bottom: 1, left: 0, right: 0, top: 0}),
					$mdgriffith$elm_ui$Element$mouseOver(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Border$color(theme.colors.darkest)
						])),
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
				]),
			elem);
	});
var $author$project$Morphir$Visual$Components$TreeLayout$defaultTheme = {
	colors: {
		selectedRowBackground: $elm$core$Maybe$Just(
			A3($mdgriffith$elm_ui$Element$rgb, 0.8, 0.9, 0.9))
	},
	icons: {
		collapsibleBranch: $mdgriffith$elm_ui$Element$text('⮞'),
		expandableBranch: $mdgriffith$elm_ui$Element$text('⮟')
	}
};
var $author$project$Morphir$Web$DevelopApp$definitionName = function (definition) {
	if (definition.$ === 'Value') {
		var _v1 = definition.a;
		var valueName = _v1.b;
		return valueName;
	} else {
		var _v2 = definition.a;
		var typeName = _v2.b;
		return typeName;
	}
};
...
var $author$project$Morphir$Web$Graph$Graph$dagListAsGraph = function (dagAsList) {
...
var $author$project$Morphir$Web$Graph$Graph$encodeEdge = function (edge) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'to',
				$elm$json$Json$Encode$int(edge.to)),
				_Utils_Tuple2(
				'from',
				$elm$json$Json$Encode$int(edge.from))
			]));
};
var $author$project$Morphir$Web$Graph$Graph$encodeNode = function (node) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$Morphir$Web$Graph$Graph$encodeGraph = function (g) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'nodes',
				A2($elm$json$Json$Encode$list, $author$project$Morphir$Web$Graph$Graph$encodeNode, g.nodes)),
				_Utils_Tuple2(
				'edges',
				A2($elm$json$Json$Encode$list, $author$project$Morphir$Web$Graph$Graph$encodeEdge, g.edges))
			]));
};
var $elm$html$Html$node = $elm$virtual_dom$VirtualDom$node;
var $author$project$Morphir$Web$Graph$Graph$visGraph = function (graphContent) {
	return A3(
		$elm$html$Html$node,
		'vis-graph',
		_List_fromArray(
			[
				...
				A2(
					...
					0,
					$author$project$Morphir$Web$Graph$Graph$encodeGraph(graphContent)))
			]),
		_List_Nil);
};
var $author$project$Morphir$Web$Graph$DependencyGraph$viewGraph = function (graph) {
	return $mdgriffith$elm_ui$Element$html(
		$author$project$Morphir$Web$Graph$Graph$visGraph(graph));
};
var $author$project$Morphir$Web$Graph$DependencyGraph$dependencyGraph = F2(
	function (selectedModule, repo) {
		var gray = A3($mdgriffith$elm_ui$Element$rgb, 0.9, 0.9, 0.9);
		var filterDepsBySelectedModule = function (deps) {
			return A2(
				$elm$core$List$filterMap,
				function (_v0) {
					var _v1 = _v0.a;
					...
					var localName = _v1.c;
					var fqNameSet = _v0.b;
					if (selectedModule.$ === 'Just') {
						var _v3 = selectedModule.a;
						var selectedModName = _v3.b;
						return _Utils_eq(selectedModName, moduleName) ? $elm$core$Maybe$Just(
							_Utils_Tuple2(
								A2(
									$elm$core$String$join,
									' ',
								...
								A2(
									...
									function (_v4) {
										...
										return A2(
											$elm$core$String$join,
											' ',
											$author$project$Morphir$IR$Name$toHumanWords(lName));
									},
									$elm$core$Set$toList(fqNameSet)))) : $elm$core$Maybe$Nothing;
					} else {
						return $elm$core$Maybe$Just(
							_Utils_Tuple2(
								A2(
								...
								A2(
									...
									$elm$core$Set$toList(fqNameSet))));
					}
				},
				$author$project$Morphir$Dependency$DAG$toList(deps));
		};
		var filterTypeDeps = filterDepsBySelectedModule(
			$author$project$Morphir$IR$Repo$typeDependencies(repo));
		var filterValueDeps = filterDepsBySelectedModule(
			$author$project$Morphir$IR$Repo$valueDependencies(repo));
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($mdgriffith$elm_ui$Element$Border$widthXY, 0, 8),
					$mdgriffith$elm_ui$Element$Border$color(gray)
				]),
			_List_fromArray(
				[
					$author$project$Morphir$Web$Graph$DependencyGraph$viewGraph(
					$author$project$Morphir$Web$Graph$Graph$dagListAsGraph(filterTypeDeps)),
					$author$project$Morphir$Web$Graph$DependencyGraph$viewGraph(
					$author$project$Morphir$Web$Graph$Graph$dagListAsGraph(filterValueDeps))
				]));
	});
...
var $author$project$Morphir$Web$DevelopApp$Common$pathToDisplayString = A2(
	...
	A2(
		...
		$elm$core$String$join(' ')),
	' > ');
var $author$project$Morphir$Web$DevelopApp$Common$pathToUrl = function (path) {
	return '/' + A3($author$project$Morphir$IR$Path$toString, $author$project$Morphir$IR$Name$toTitleCase, '.', path);
};
var $author$project$Morphir$Web$DevelopApp$Common$pathToFullUrl = function (path) {
	return '/home' + $elm$core$String$concat(
		A2($elm$core$List$map, $author$project$Morphir$Web$DevelopApp$Common$pathToUrl, path));
};
...
var $author$project$Morphir$Visual$Components$TreeLayout$viewSubTree = F4(
	function (theme, config, nodePath, _v0) {
		var label = _v0.a;
		var attributes = _v0.b;
		var children = _v0.c;
		var indentRight = function (by) {
			return $mdgriffith$elm_ui$Element$paddingEach(
				{bottom: 0, left: by * 20, right: 0, top: 0});
		};
		var handle = F2(
			function (icon, maybeOnClick) {
				...
				var attribs = function () {
					if (maybeOnClick.$ === 'Just') {
						var handleOnClick = maybeOnClick.a;
						return _Utils_ap(
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$Events$onClick(
									handleOnClick(nodePath)),
									$mdgriffith$elm_ui$Element$pointer
								]),
							style);
					} else {
		...
		var depth = $elm$core$List$length(nodePath);
		var viewNode = function (collapseControl) {
			var configurableStyles = A2(
				$elm$core$List$filterMap,
				$elm$core$Basics$identity,
				_List_fromArray(
					[
						A2($elm$core$Set$member, nodePath, config.selectedPaths) ? A2($elm$core$Maybe$map, $mdgriffith$elm_ui$Element$Background$color, theme.colors.selectedRowBackground) : $elm$core$Maybe$Nothing
					]));
			return A2(
				$mdgriffith$elm_ui$Element$el,
				$elm$core$List$concat(
		...
		return $elm$core$Dict$isEmpty(children) ? _List_fromArray(
			[
				viewNode(
				A2(handle, $mdgriffith$elm_ui$Element$none, $elm$core$Maybe$Nothing))
			]) : (A2($elm$core$Set$member, nodePath, config.collapsedPaths) ? _List_fromArray(
			[
				viewNode(
				A2(
					handle,
					A2($mdgriffith$elm_ui$Element$map, $elm$core$Basics$never, theme.icons.expandableBranch),
					$elm$core$Maybe$Just(config.onExpand)))
			]) : $elm$core$List$concat(
			_List_fromArray(
				[
					_List_fromArray(
					[
						...
						A2(
							handle,
							A2($mdgriffith$elm_ui$Element$map, $elm$core$Basics$never, theme.icons.collapsibleBranch),
							$elm$core$Maybe$Just(config.onCollapse)))
					]),
					$elm$core$List$concat(
					A2(
						$elm$core$List$map,
						function (_v1) {
							...
							var childNode = _v1.b;
							return A4(
								$author$project$Morphir$Visual$Components$TreeLayout$viewSubTree,
								theme,
								config,
								A2($elm$core$List$cons, key, nodePath),
								childNode);
						},
						$elm$core$Dict$toList(children)))
				])));
	});
var $author$project$Morphir$Visual$Components$TreeLayout$view = F3(
	function (theme, config, node) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			A4($author$project$Morphir$Visual$Components$TreeLayout$viewSubTree, theme, config, _List_Nil, node));
	});
...
var $author$project$Morphir$Web$DevelopApp$viewAsLabel = F5(
	function (theme, icon, header, _class, url) {
		var elem = A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
					...
					A2($author$project$Morphir$Visual$Theme$scaled, 2, theme)),
					$mdgriffith$elm_ui$Element$pointer
				]),
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							A2($author$project$Morphir$Visual$Theme$scaled, -10, theme),
							A2($author$project$Morphir$Visual$Theme$scaled, -3, theme))
						]),
					header),
					A2(
					$mdgriffith$elm_ui$Element$el,
...
var $author$project$Morphir$Web$DevelopApp$viewDefinitionDetails = F2(
	function (irState, maybeSelectedDefinition) {
		if (irState.$ === 'IRLoading') {
			return $mdgriffith$elm_ui$Element$none;
		} else {
			var _v1 = irState.a;
			var packageDef = _v1.c;
			if (maybeSelectedDefinition.$ === 'Just') {
				var selectedDefinition = maybeSelectedDefinition.a;
				if (selectedDefinition.$ === 'Value') {
					var _v4 = selectedDefinition.a;
					var moduleName = _v4.a;
					var valueName = _v4.b;
					return A2(
						$elm$core$Maybe$withDefault,
						...
						A2(
							...
							function (accessControlledModuleDef) {
								return A2(
									$elm$core$Maybe$map,
									function (_v5) {
										var _v6 = A2($elm$core$Dict$get, moduleName, packageDef.modules);
										if (_v6.$ === 'Just') {
											var acmoduledef = _v6.a;
											return A2(
												$elm$core$Maybe$withDefault,
												$mdgriffith$elm_ui$Element$none,
												A2(
													$elm$core$Maybe$andThen,
													function (accessControlledValueDef) {
														return $elm$core$Maybe$Just(
															A2(
																$author$project$Morphir$Visual$XRayView$viewValueDefinition,
																$author$project$Morphir$Visual$XRayView$viewType($author$project$Morphir$Web$DevelopApp$Common$pathToUrl),
																accessControlledValueDef.value.value));
													},
													A2($elm$core$Dict$get, valueName, acmoduledef.value.values)));
										} else {
											return $mdgriffith$elm_ui$Element$none;
										}
									},
...
var $author$project$Morphir$Visual$Components$TreeLayout$Node = F3(
	function (a, b, c) {
		return {$: 'Node', a: a, b: b, c: c};
	});
var $author$project$Morphir$Visual$Common$nameToTitleText = function (name) {
	return A2(
		$elm$core$String$join,
		' ',
		A2(
			$elm$core$List$map,
			function (word) {
				return $author$project$Morphir$IR$Name$toTitleCase(
					_List_fromArray(
						[word]));
			},
			$author$project$Morphir$IR$Name$toHumanWords(name)));
};
var $author$project$Morphir$Web$DevelopApp$viewModuleNames = F4(
	function (model, packageName, parentModule, allModuleNames) {
		var currentModuleName = $elm$core$List$head(
			$elm$core$List$reverse(parentModule));
		var childModuleNames = $elm$core$Set$toList(
			$elm$core$Set$fromList(
				A2(
					$elm$core$List$filterMap,
					function (moduleName) {
						return A2($author$project$Morphir$IR$Path$isPrefixOf, moduleName, parentModule) ? $elm$core$List$head(
							A2(
								$elm$core$List$drop,
								$elm$core$List$length(parentModule),
								moduleName)) : $elm$core$Maybe$Nothing;
					},
					allModuleNames)));
		return A3(
			$author$project$Morphir$Visual$Components$TreeLayout$Node,
			function (_v0) {
				if (currentModuleName.$ === 'Just') {
					var name = currentModuleName.a;
					return A2(
						$mdgriffith$elm_ui$Element$link,
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$pointer]),
						{
							label: $mdgriffith$elm_ui$Element$text(
								$author$project$Morphir$Visual$Common$nameToTitleText(name)),
							url: _Utils_ap(
								$author$project$Morphir$Web$DevelopApp$Common$pathToFullUrl(
									_List_fromArray(
										[packageName, parentModule])),
								$author$project$Morphir$Web$DevelopApp$filterStateToQueryParams(model.homeState.filterState))
						});
				} else {
					return A2(
						$mdgriffith$elm_ui$Element$link,
						...
						{
							label: $mdgriffith$elm_ui$Element$text(
								$author$project$Morphir$Web$DevelopApp$Common$pathToUrl(packageName)),
							url: _Utils_ap(
								$author$project$Morphir$Web$DevelopApp$Common$pathToFullUrl(
									_List_fromArray(
										[packageName])),
			...
			$elm$core$Dict$fromList(
				A2(
					$elm$core$List$map,
					function (name) {
						var moduleName = _Utils_ap(
							parentModule,
							_List_fromArray(
								[name]));
						return _Utils_Tuple2(
							moduleName,
							A4($author$project$Morphir$Web$DevelopApp$viewModuleNames, model, packageName, moduleName, allModuleNames));
					},
					childModuleNames)));
	});
...
var $author$project$Morphir$Visual$Theme$labelStyles = function (theme) {
	return _List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
			$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
			...
			$mdgriffith$elm_ui$Element$Border$widthEach(
			{bottom: 1, left: 0, right: 0, top: 0}),
			$mdgriffith$elm_ui$Element$Border$color(theme.colors.backgroundColor)
		]);
};
var $author$project$Morphir$Visual$Theme$boldLabelStyles = function (theme) {
	return A2(
		$elm$core$List$cons,
		$mdgriffith$elm_ui$Element$Font$bold,
		$author$project$Morphir$Visual$Theme$labelStyles(theme));
};
...
var $author$project$Morphir$Visual$Theme$twoColumnTableView = F3(
	function (tableData, leftView, rightView) {
		return A2(
				...
				]),
			{
				columns: _List_fromArray(
					[
						{header: $mdgriffith$elm_ui$Element$none, view: leftView, width: $mdgriffith$elm_ui$Element$fill},
						{header: $mdgriffith$elm_ui$Element$none, view: rightView, width: $mdgriffith$elm_ui$Element$fill}
					]),
				data: tableData
			});
	});
...
var $author$project$Morphir$Web$DevelopApp$viewAsCard = F6(
	function (theme, header, _class, backgroundColor, docs, content) {
		var white = A3($mdgriffith$elm_ui$Element$rgb, 1, 1, 1);
		var cont = A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
				...
				[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$paddingXY,
							A2($author$project$Morphir$Visual$Theme$scaled, -2, theme),
							A2($author$project$Morphir$Visual$Theme$scaled, -6, theme)),
							$mdgriffith$elm_ui$Element$spacing(
							A2($author$project$Morphir$Visual$Theme$scaled, 2, theme)),
							$mdgriffith$elm_ui$Element$Font$size(
							A2($author$project$Morphir$Visual$Theme$scaled, 3, theme))
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color(white),
							$mdgriffith$elm_ui$Element$Border$rounded(3),
							$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
							$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill)
						]),
							...
							[
								...
								_List_fromArray(
									[
										...
										$mdgriffith$elm_ui$Element$Border$color(backgroundColor),
										$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
										$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
									]),
								function () {
									...
									var _v0 = A2(
										...
										A2(
											$elm$core$Result$mapError,
											deadEndsToString,
											$dillonkearns$elm_markdown$Markdown$Parser$parse(docs)));
									if (_v0.$ === 'Ok') {
										var rendered = _v0.a;
										return A2(
											$mdgriffith$elm_ui$Element$paragraph,
											_List_Nil,
											A2($elm$core$List$map, $mdgriffith$elm_ui$Element$html, rendered));
									} else {
										var errors = _v0.a;
...
var $author$project$Morphir$Web$DevelopApp$viewType = F4(
	function (theme, typeName, typeDef, docs) {
		if (typeDef.$ === 'TypeAliasDefinition') {
			if (typeDef.b.$ === 'Record') {
				var _v1 = typeDef.b;
				var fields = _v1.b;
				var fieldTypes = function (field) {
					return A2(
						$mdgriffith$elm_ui$Element$el,
						$author$project$Morphir$Visual$Theme$labelStyles(theme),
						A2($author$project$Morphir$Visual$XRayView$viewType, $author$project$Morphir$Web$DevelopApp$Common$pathToUrl, field.tpe));
				};
				var fieldNames = function (field) {
					return A2(
						$mdgriffith$elm_ui$Element$el,
						$author$project$Morphir$Visual$Theme$boldLabelStyles(theme),
						$mdgriffith$elm_ui$Element$text(
							$author$project$Morphir$Visual$Common$nameToText(field.name)));
				};
				var viewFields = A3($author$project$Morphir$Visual$Theme$twoColumnTableView, fields, fieldNames, fieldTypes);
				return A6(
					$author$project$Morphir$Web$DevelopApp$viewAsCard,
					theme,
					$mdgriffith$elm_ui$Element$text(
						$author$project$Morphir$Visual$Common$nameToTitleText(typeName)),
					'record',
				...
				return A6(
					...
					A2(
						...
						A2($author$project$Morphir$Visual$XRayView$viewType, $author$project$Morphir$Web$DevelopApp$Common$pathToUrl, body)));
			}
		} else {
			var accessControlledConstructors = typeDef.b;
			var isNewType = function () {
				var _v7 = $elm$core$Dict$toList(accessControlledConstructors.value);
				if (((_v7.b && _v7.a.b.b) && (!_v7.a.b.b.b)) && (!_v7.b.b)) {
					var _v8 = _v7.a;
					var ctorName = _v8.a;
					var _v9 = _v8.b;
					var _v10 = _v9.a;
					var baseType = _v10.b;
					return _Utils_eq(ctorName, typeName) ? $elm$core$Maybe$Just(baseType) : $elm$core$Maybe$Nothing;
				} else {
					return $elm$core$Maybe$Nothing;
				}
			}();
						...
						A2(
							...
							function (_v3) {
								...
								return A2(
									...
									$author$project$Morphir$Visual$Theme$boldLabelStyles(theme),
									$mdgriffith$elm_ui$Element$text(
										$author$project$Morphir$Visual$Common$nameToTitleText(ctorName)));
							},
							$elm$core$Dict$toList(accessControlledConstructors.value)));
				} else {
					if (isNewType.$ === 'Just') {
						var baseType = isNewType.a;
						return A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
							...
							A2($author$project$Morphir$Visual$XRayView$viewType, $author$project$Morphir$Web$DevelopApp$Common$pathToUrl, baseType));
					} else {
						var constructorNames = function (_v6) {
							var ctorName = _v6.a;
							return A2(
								$mdgriffith$elm_ui$Element$el,
								$author$project$Morphir$Visual$Theme$boldLabelStyles(theme),
						...
						var constructorArgs = function (_v5) {
							var ctorArgs = _v5.b;
							return A2(
								$mdgriffith$elm_ui$Element$el,
								$author$project$Morphir$Visual$Theme$labelStyles(theme),
						...
						return A3(
							$author$project$Morphir$Visual$Theme$twoColumnTableView,
							$elm$core$Dict$toList(accessControlledConstructors.value),
							constructorNames,
							constructorArgs);
					}
			...
			return A6(
				...
				function () {
					if (isNewType.$ === 'Just') {
						...
						return isEnum ? 'enum' : 'one of';
					}
				}(),
				$author$project$Morphir$Visual$Theme$defaultColors.backgroundColor,
				docs,
				viewConstructors);
		}
	});
		...
		var cardTitle = A2(
				...
				[$mdgriffith$elm_ui$Element$pointer]),
			{
				...
				url: '/module/' + (A2(
					$elm$core$String$join,
					'.',
					A2($elm$core$List$map, $author$project$Morphir$IR$Name$toTitleCase, moduleName)) + ('?filter=' + $author$project$Morphir$Visual$Common$nameToText(valueName)))
			});
		var backgroundColor = isData ? A3($mdgriffith$elm_ui$Element$rgb, 0.8, 0.9, 0.9) : A3($mdgriffith$elm_ui$Element$rgb, 0.8, 0.8, 0.9);
		return A6(
			$author$project$Morphir$Web$DevelopApp$viewAsCard,
			theme,
			cardTitle,
...
var $author$project$Morphir$Web$DevelopApp$viewHome = F3(
	function (model, packageName, packageDef) {
		var viewDefinition = function (maybeSelectedDefinition) {
			if (maybeSelectedDefinition.$ === 'Just') {
				var selectedDefinition = maybeSelectedDefinition.a;
				if (selectedDefinition.$ === 'Value') {
					var _v11 = selectedDefinition.a;
					var moduleName = _v11.a;
					var valueName = _v11.b;
					return A2(
						$elm$core$Maybe$withDefault,
						$mdgriffith$elm_ui$Element$none,
						A2(
					...
					var _v12 = selectedDefinition.a;
					var moduleName = _v12.a;
					var typeName = _v12.b;
					return A2(
						$elm$core$Maybe$withDefault,
						$mdgriffith$elm_ui$Element$none,
						A2(
							...
							function (accessControlledModuleDef) {
								return A2(
									$elm$core$Maybe$map,
									function (typeDef) {
										return A4($author$project$Morphir$Web$DevelopApp$viewType, model.theme, typeName, typeDef.value.value, typeDef.value.doc);
									},
									A2($elm$core$Dict$get, typeName, accessControlledModuleDef.value.types));
							},
							A2($elm$core$Dict$get, moduleName, packageDef.modules)));
				}
			} else {
				return $mdgriffith$elm_ui$Element$text('Please select a definition on the left!');
			}
		};
		var valueCheckbox = A2(
				...
				]),
			{
				...
				label: A2(
					...
					_List_Nil,
					$mdgriffith$elm_ui$Element$text('values:')),
				onChange: $author$project$Morphir$Web$DevelopApp$ToggleValues
			});
		var typeCheckbox = A2(
			$mdgriffith$elm_ui$Element$Input$checkbox,
			_List_fromArray(
				...
				]),
			{
				...
				label: A2(
					$mdgriffith$elm_ui$Element$Input$labelLeft,
					_List_Nil,
					$mdgriffith$elm_ui$Element$text('types:')),
				onChange: $author$project$Morphir$Web$DevelopApp$ToggleTypes
			});
		var toggleModulesMenu = A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$padding(7),
					$mdgriffith$elm_ui$Element$Background$color(
					A4($mdgriffith$elm_ui$Element$rgba, 0, 0.639, 0.882, 0.6)),
					$mdgriffith$elm_ui$Element$Border$rounded(3),
					$mdgriffith$elm_ui$Element$Font$color(model.theme.colors.lightest),
					$mdgriffith$elm_ui$Element$Font$bold,
					$mdgriffith$elm_ui$Element$Font$size(
					A2($author$project$Morphir$Visual$Theme$scaled, 2, model.theme)),
					$mdgriffith$elm_ui$Element$mouseOver(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color(
							A3($mdgriffith$elm_ui$Element$rgb, 0, 0.639, 0.882))
						]))
				]),
			{
				label: A2(
		...
		var scrollableListStyles = _List_fromArray(
			[
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$Background$color(model.theme.colors.lightest),
				$mdgriffith$elm_ui$Element$Border$rounded(3),
		...
		var pathToSelectedModule = function () {
			var _v8 = A2($elm$core$Maybe$map, $elm$core$Tuple$second, model.homeState.selectedModule);
			if (_v8.$ === 'Just') {
				var moduleName = _v8.a;
				return '> ' + $author$project$Morphir$Web$DevelopApp$Common$pathToDisplayString(moduleName);
			} else {
				return '>';
			}
		}();
		var moduleTree = A2(
			...
			A3(
				$author$project$Morphir$Visual$Components$TreeLayout$view,
				$author$project$Morphir$Visual$Components$TreeLayout$defaultTheme,
				{
					collapsedPaths: model.collapsedModules,
					onCollapse: $author$project$Morphir$Web$DevelopApp$CollapseModule,
					onExpand: $author$project$Morphir$Web$DevelopApp$ExpandModule,
					selectedPaths: A2(
						$elm$core$Maybe$withDefault,
						$elm$core$Set$empty,
						A2(
							$elm$core$Maybe$map,
							A2($elm$core$Basics$composeR, $elm$core$Tuple$first, $elm$core$Set$singleton),
							model.homeState.selectedModule))
				},
				A4(
					$author$project$Morphir$Web$DevelopApp$viewModuleNames,
					model,
					packageName,
					_List_Nil,
					$elm$core$Dict$keys(packageDef.modules))));
		var moduleDefinitionsAsUiElements = F2(
			function (moduleName, moduleDef) {
				var linkToDefinition = F2(
					function (name, nameTransformation) {
						return $author$project$Morphir$Web$DevelopApp$Common$pathToFullUrl(
							_List_fromArray(
								[packageName, moduleName])) + ('/' + (nameTransformation(name) + $author$project$Morphir$Web$DevelopApp$filterStateToQueryParams(model.homeState.filterState)));
					});
				var createUiElement = F4(
					function (icon, definition, name, nameTransformation) {
						return A5(
							$author$project$Morphir$Web$DevelopApp$viewAsLabel,
							model.theme,
							icon,
							$mdgriffith$elm_ui$Element$text(
								$author$project$Morphir$Visual$Common$nameToText(name)),
							$author$project$Morphir$Web$DevelopApp$Common$pathToDisplayString(moduleName),
							A2(linkToDefinition, name, nameTransformation));
					});
				var types = A2(
					$elm$core$List$map,
					function (_v7) {
				...
				var values = A2(
					...
					function (_v6) {
						...
						return _Utils_Tuple2(
							$author$project$Morphir$Web$DevelopApp$Value(
								_Utils_Tuple2(moduleName, valueName)),
							A4(
								createUiElement,
								A2(
									$mdgriffith$elm_ui$Element$el,
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$Font$color(
											A4($mdgriffith$elm_ui$Element$rgba, 1, 0.411, 0, 0.6))
										]),
									$mdgriffith$elm_ui$Element$text('ⓥ ')),
								$author$project$Morphir$Web$DevelopApp$Value(
									_Utils_Tuple2(moduleName, valueName)),
					...
					$elm$core$Dict$toList(moduleDef.values));
				return _Utils_ap(
					A3($author$project$Morphir$Web$DevelopApp$Common$ifThenElse, model.homeState.filterState.showValues, values, _List_Nil),
					A3($author$project$Morphir$Web$DevelopApp$Common$ifThenElse, model.homeState.filterState.showTypes, types, _List_Nil));
			});
		var viewDefinitionLabels = function (maybeSelectedModuleName) {
			var searchFilter = function (definitions) {
				var searchTextContainsDefName = function (defName) {
					return A2(
						$elm$core$String$contains,
						model.homeState.filterState.searchText,
				...
				return A2(
					...
					function (_v5) {
						...
						return searchTextContainsDefName(
							$author$project$Morphir$Web$DevelopApp$definitionName(definition));
					},
					definitions);
			};
			var paintSelectedElement = function () {
				var paintIfSelected = function (elem) {
					return A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Background$color(model.theme.colors.selectionColor),
								$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
							]),
						elem);
				};
				return $elm$core$List$map(
					function (_v3) {
						var def = _v3.a;
						var elem = _v3.b;
						var _v4 = model.homeState.selectedDefinition;
						if (_v4.$ === 'Just') {
							var selected = _v4.a;
							return _Utils_eq(selected, def) ? paintIfSelected(elem) : A2($author$project$Morphir$Visual$Theme$defaultClickableListElem, model.theme, elem);
						} else {
							return A2($author$project$Morphir$Visual$Theme$defaultClickableListElem, model.theme, elem);
						}
					});
			}();
			var defaultIfUnselected = function (definitionElementList) {
				return $elm$core$List$isEmpty(definitionElementList) ? ((model.homeState.filterState.searchText === '') ? _List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text('Please select a module on the left!')
					]) : _List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text('No matching definition in this module.')
					])) : definitionElementList;
			};
			var alphabeticalOrdering = function (list) {
				var byDefinitionName = function (_v2) {
				...
				return A2(
					...
					$matthewsj$elm_ordering$Ordering$byField(byDefinitionName),
					list);
			};
			return A2(
				$mdgriffith$elm_ui$Element$column,
							...
							searchFilter(
								A2(
									...
									function (_v0) {
										var moduleName = _v0.a;
										var accessControlledModuleDef = _v0.b;
										if (maybeSelectedModuleName.$ === 'Just') {
											var selectedModuleName = maybeSelectedModuleName.a;
											return A2($author$project$Morphir$IR$Path$isPrefixOf, moduleName, selectedModuleName) ? A2(moduleDefinitionsAsUiElements, moduleName, accessControlledModuleDef.value) : _List_Nil;
										} else {
											return _List_Nil;
										}
									},
		...
		var definitionFilter = A2(
				...
				]),
			{
				...
				onChange: $author$project$Morphir$Web$DevelopApp$SearchDefinition,
				placeholder: $elm$core$Maybe$Just(
					A2(
						$mdgriffith$elm_ui$Element$Input$placeholder,
						_List_Nil,
						$mdgriffith$elm_ui$Element$text('Search for a definition'))),
				...
				[
										...
										[
											...
											_List_fromArray(
												[
													...
													$mdgriffith$elm_ui$Element$paddingXY,
													0,
													A2($author$project$Morphir$Visual$Theme$scaled, -5, model.theme))
												]),
											_List_fromArray(
												[
													definitionFilter,
											...
											$mdgriffith$elm_ui$Element$el,
											scrollableListStyles,
											viewDefinitionLabels(
												A2($elm$core$Maybe$map, $elm$core$Tuple$second, model.homeState.selectedModule)))
										]))
								]))
						])),
					A2(
					...
					_List_fromArray(
						[
							A3(
							$author$project$Morphir$Web$DevelopApp$Common$ifThenElse,
							_Utils_eq(model.homeState.selectedDefinition, $elm$core$Maybe$Nothing),
							A2($author$project$Morphir$Web$Graph$DependencyGraph$dependencyGraph, model.homeState.selectedModule, model.repo),
							A2(
								$mdgriffith$elm_ui$Element$column,
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										A2($author$project$Morphir$Web$DevelopApp$viewDefinitionDetails, model.irState, model.homeState.selectedDefinition))
									])))
						]))
				]));
	});
var $author$project$Morphir$Web$DevelopApp$viewBody = function (model) {
	var _v0 = model.irState;
	if (_v0.$ === 'IRLoading') {
		return $mdgriffith$elm_ui$Element$text('Loading the IR ...');
	} else {
		var distribution = _v0.a;
		var packageName = distribution.a;
		var packageDef = distribution.c;
		return A3($author$project$Morphir$Web$DevelopApp$viewHome, model, packageName, packageDef);
	}
};
...
var $author$project$Morphir$Web$DevelopApp$viewHeader = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$Background$color(model.theme.colors.primaryHighlight)
			]),
		_List_fromArray(
			[
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$text('Morphir Web'))
							]))
					]))
			]));
};
var $author$project$Morphir$Web$DevelopApp$viewServerError = function (error) {
	var message = function () {
		switch (error.$) {
			case 'BadUrl':
				var url = error.a;
				return 'An invalid URL was provided: ' + url;
			case 'Timeout':
			...
			case 'BadStatus':
				var code = error.a;
				return 'Server returned an error: ' + $elm$core$String$fromInt(code);
			default:
				var body = error.a;
				return 'Unexpected response body: ' + body;
		}
	}();
	return A2(
		$mdgriffith$elm_ui$Element$el,
...
var $author$project$Morphir$Web$DevelopApp$viewTitle = 'Morphir - Home';
var $author$project$Morphir$Web$DevelopApp$view = function (model) {
	return {
		body: _List_fromArray(
			[
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$Morphir$Web$DevelopApp$viewHeader(model),
							function () {
							var _v0 = model.serverState;
							if (_v0.$ === 'ServerReady') {
								return $mdgriffith$elm_ui$Element$none;
							} else {
								var error = _v0.a;
								return $author$project$Morphir$Web$DevelopApp$viewServerError(error);
							}
						}(),
							A2(
							$mdgriffith$elm_ui$Element$el,
							...
							$author$project$Morphir$Web$DevelopApp$viewBody(model))
						])))
			]),
		title: $author$project$Morphir$Web$DevelopApp$viewTitle
	};
};
var $author$project$Morphir$Web$DevelopApp$main = $elm$browser$Browser$application(
	{init: $author$project$Morphir$Web$DevelopApp$init, onUrlChange: $author$project$Morphir$Web$DevelopApp$UrlChanged, onUrlRequest: $author$project$Morphir$Web$DevelopApp$LinkClicked, subscriptions: $author$project$Morphir$Web$DevelopApp$subscriptions, update: $author$project$Morphir$Web$DevelopApp$update, view: $author$project$Morphir$Web$DevelopApp$view});
_Platform_export({'Morphir':{'Web':{'DevelopApp':{'init':$author$project$Morphir$Web$DevelopApp$main(
