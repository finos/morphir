...
import Morphir.Graph.Backend as Graph
...
type BackendOptions
    ...
    | GraphOptions Morphir.Scala.Backend.Options
...
decodeOptions gen =
    case gen of
        ...
        Ok "graph" -> Decode.map (\(options) -> GraphOptions(options)) Morphir.Graph.Backend.Codec.decodeOptions
...
mapDistribution back dist =
    case back of
            ...
            GraphOptions options -> Graph.mapDistribution options dist
