...
class test1 extends FunSuite {
  ...
  val antiqueSS_data = localTestSession.read
    .format("csv")
    .option("header", "true")
  ...
  test("testCaseString") {
    val df_expected_results = localTestSession.read
      ...
      .schema(antiqueSS_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testCaseString.csv"
      )
  ...
  test("testListMinimum") {
    val df_expected_results = localTestSession.read
      ...
      .schema(foo_float_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testListMinimum.csv"
      )
  ...
  test("testListMaximum") {
    val df_expected_results = localTestSession.read
      ...
      .schema(foo_float_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testListMaximum.csv"
      )
  ...
  test("testNameMaximum") {
    val df_expected_results = localTestSession.read
      ...
      .load(
        "spark/test/src/spark_test_data/expected_results_testNameMaximum.csv"
      )
  ...
  test("testLetBinding") {
    val df_expected_results = localTestSession.read
      ...
      .schema(antiqueSS_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testLetBinding.csv"
      )
  ...
  test("testListLength") {
    val df_expected_results = localTestSession.read
      ...
      .schema(foo_int_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testListLength.csv"
      )
