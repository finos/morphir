...
class SparkTypeTest extends FunSuite {
  ...
  val foo_float_data = localTestSession.read
    .format("csv")
    .option("header", "true")
  ...
  val foo_int_data = localTestSession.read
    .format("csv")
    .option("header", "true")
  ...
  val foo_bool_data = localTestSession.read
    .format("csv")
    .option("header", "true")
  ...
  val foo_string_data = localTestSession.read
    .format("csv")
    .option("header", "true")
  ...
  val product_data = localTestSession.read
    .format("csv")
    .option("header", "true")
...
//////////////////////////////////////////////////////////////////////////////
  ...
  test("testMaybeString") {
    val df_expected_results = localTestSession.read
      ...
      .schema(foo_string_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testMaybeString.csv"
      )
  ...
  test("testMaybeFloat") {
    val df_expected_results = localTestSession.read
      ...
      .schema(foo_float_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testMaybeFloat.csv"
      )
  ...
  test("testMaybeBoolConditional") {
    val df_expected_results = localTestSession.read
      ...
      .schema(foo_bool_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testMaybeBoolConditional.csv"
      )
  ...
  test("testMaybeBoolConditionalNull") {
    val df_expected_results = localTestSession.read
      ...
      .schema(foo_bool_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testMaybeBoolConditionalNull.csv"
      )

    val df_actual_results =
      SparkJobs.testMaybeBoolConditionalNull(foo_bool_data)
  ...
  test("testMaybeBoolConditionalNotNull") {
    val df_expected_results = localTestSession.read
      ...
      .schema(foo_bool_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testMaybeBoolConditionalNotNull.csv"
      )

    val df_actual_results =
      SparkJobs.testMaybeBoolConditionalNotNull(foo_bool_data)
  ...
  test("testMaybeMapDefault") {
    val df_expected_results = localTestSession.read
      ...
      .schema(foo_bool_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testMaybeMapDefault.csv"
      )
