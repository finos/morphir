...
class listMemberTest extends FunSuite {
  ...
  val antique_product_test_data = localTestSession.read
    .format("csv")
    .option("header", "true")
  ...
  test("testEnumListMember") {
    val df_expected_results = localTestSession.read
      ...
      .schema(antique_product_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testEnumListMember.csv"
      )

    val df_actual_results =
      SparkJobs.testEnumListMember(antique_product_test_data)
  ...
  val antique_age_test_data = localTestSession.read
    .format("csv")
    .option("header", "true")
  ...
  test("testIntListMember") {
    val df_expected_results = localTestSession.read
      ...
      .schema(antique_age_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testIntListMember.csv"
      )
  ...
  val antique_name_test_data = localTestSession.read
    .format("csv")
    .option("header", "true")
  ...
  test("testStringListMember") {
    val df_expected_results = localTestSession.read
      ...
      .schema(antique_name_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testStringListMember.csv"
      )

    val df_actual_results =
      SparkJobs.testStringListMember(antique_name_test_data)
