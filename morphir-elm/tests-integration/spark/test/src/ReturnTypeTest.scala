...
class returnTypeTest extends FunSuite {
  ...
  val df_age_test_data = localTestSession.read
    .format("csv")
    .option("header", "true")
  ...
  test("testReturnListRecords") {
    val df_expected_results = localTestSession.read
      ...
      .load(
        "spark/test/src/spark_test_data/expected_results_testReturnListRecords.csv"
      )
  ...
  test("testReturnValue1") {
    val df_expected_results = localTestSession.read
      ...
      .schema(new StructType().add("foo", DoubleType, false))
      .load(
        "spark/test/src/spark_test_data/expected_results_testReturnValue1.csv"
      )
  ...
  test("testReturnValue2") {
    val df_expected_results = localTestSession.read
      ...
      .load(
        "spark/test/src/spark_test_data/expected_results_testReturnValue2.csv"
      )
  ...
  test("testReturnMaybe") {
    val df_expected_results = localTestSession.read
      ...
      .load(
        "spark/test/src/spark_test_data/expected_results_testReturnMaybe.csv"
      )
  ...
  test("testReturnRecord") {
    val df_expected_results = localTestSession.read
      ...
      .load(
        "spark/test/src/spark_test_data/expected_results_testReturnRecord.csv"
      )
  ...
  test("testReturnApplyRecord") {
    val df_expected_results = localTestSession.read
      ...
      .load(
        "spark/test/src/spark_test_data/expected_results_testReturnApplyRecord.csv"
      )
  ...
  test("testReturnInlineApplyRecord") {
    val df_expected_results = localTestSession.read
      ...
      .load(
        "spark/test/src/spark_test_data/expected_results_testReturnInlineApplyRecord.csv"
      )

    val df_actual_results =
      SparkJobs.testReturnInlineApplyRecord(df_age_test_data)
