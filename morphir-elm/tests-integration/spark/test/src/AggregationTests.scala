...
class aggregationTest extends FunSuite {
  ...
  test("aggregateAverage") {
    ...
    val df_expected_results = localTestSession.read
      ...
      .schema(out_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testAggregateAverage.csv"
      )
  ...
  test("aggregateCount") {
    ...
    val df_expected_results = localTestSession.read
      ...
      .schema(out_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testAggregateCount.csv"
      )
  ...
  test("aggregateFilterAll") {
    ...
    val df_expected_results = localTestSession.read
      ...
      .schema(out_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testAggregateFilterAll.csv"
      )
  ...
  test("aggregateFilterOneCount") {
    ...
    val df_expected_results = localTestSession.read
      ...
      .schema(out_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testAggregateFilterOneCount.csv"
      )
  ...
  test("aggregateFilterOneMin") {
    ...
    val df_expected_results = localTestSession.read
      ...
      .schema(out_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testAggregateFilterOneMin.csv"
      )
  ...
  test("aggregateSum") {
    ...
    val df_expected_results = localTestSession.read
      ...
      .schema(out_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testAggregateSum.csv"
      )
  ...
  test("aggregateMaximum") {
    ...
    val df_expected_results = localTestSession.read
      ...
      .schema(out_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testAggregateMaximum.csv"
      )
  ...
  test("aggregateMinimum") {
    ...
    val df_expected_results = localTestSession.read
      ...
      .schema(out_schema)
      .load(
        "spark/test/src/spark_test_data/expected_results_testAggregateMinimum.csv"
      )
