...
<img src="/img/morphir-web-ui/overview.png" alt="UI overview" width="100%" height="100%" title="UI overview"/>
...
<img src="/img/morphir-web-ui/sidebar.png" alt="sidebar" width="30%" height="30%" title="Navigation sidebar"/>
...
<img src="/img/morphir-web-ui/navurl.png" alt="URL reflecting navigation" width="70%" height="70%" title="URL reflecting navigation"/>
...
<img src="/img/morphir-web-ui/module.png" alt="Module details with tabs" width="100%" height="100%" title="Module details with tabs"/>
~
...
<img src="/img/morphir-web-ui/defdetails1.png" alt="Insight view" width="80%" height="80%" title="Insight view"/>

~

<img src="/img/morphir-web-ui/defdetails2.png" alt="XRay view" width="80%" height="80%" title="Xray view"/>

~

<img src="/img/morphir-web-ui/defdetails3.png" alt="Decorations" width="80%" height="80%" title="Decorations"/>
...
<img src="/img/morphir-web-ui/typedetails.png" alt="Type Details" width="80%" height="80%" title="Type Details"/>
...
<img src="/img/morphir-web-ui/insight.png" alt="Insight view" width="50%" height="50%" title="Insight view"/>
...
<img src="/img/morphir-web-ui/insightex1.png" alt="Insight view Example #1" width="50%" height="50%" title="Insight view Example #1"/>
...
<img src="/img/morphir-web-ui/insightex2a.png" alt="Insight view Example #2a" width="30%" height="30%" title="Insight view Example #2a"/>
...
<img src="/img/morphir-web-ui/insightex2b.png" alt="Insight view Example #2b" width="30%" height="30%" title="Insight view Example #2b"/>

~

Whith another click, this drilldown panel can be closed.

<img src="/img/morphir-web-ui/valuepopup.png" alt="Insight view Value popup" width="30%" height="30%" title="Insight view value popup"/>
...
<img src="/img/morphir-web-ui/insightex3a.png" alt="Insight view Optional Input - no value" width="30%" height="30%" title="Insight view Optional Input - no value"/>  
<img src="/img/morphir-web-ui/insightex3b.png" alt="Insight view Optional Input - value returned" width="30%" height="30%" title="Insight view Optional Input - value returned"/>
...
<img src="/img/morphir-web-ui/xrayviewInsight.png" alt="Example function in Insight View" width="50%" height="50%" title="Example function in Insight View"/>
<img src="/img/morphir-web-ui/xrayviewXray.png" alt="Example function in Xray View" width="35%" height="35%" title="Example function in Xray View"/>
...
<img src="/img/morphir-web-ui/xrayExplanation.png" alt="Xray View Explanation" width="50%" height="50%" title="Xray View Explanation"/>
...
<img src="/img/morphir-web-ui/warning.png" alt="Warning" width="80%" height="80%" title="Warning"/>
...
<img src="/img/morphir-web-ui/error.png" alt="Error" width="80%" height="80%" title="Error"/>
