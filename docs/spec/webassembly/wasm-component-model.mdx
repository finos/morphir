...
- [Wasm Backend Design](./wasm-backend) — Compiler architecture for Wasm targets
- [WIT Frontend](./wit-frontend) — Parsing WIT interfaces into Morphir IR
- [WAT Code Generation](./wat-codegen) — Emitting human-readable WAT
...
- [Morphir IR v4 Attributes](../../design/draft/ir/attributes.mdx)
