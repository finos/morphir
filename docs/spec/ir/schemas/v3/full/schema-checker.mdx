---
title: "Schema Checker - Version 3"
sidebar_label: "Schema Checker"
sidebar_position: 2
description: "Validate Morphir IR JSON against the Version 3 schema"
---
...
- [Schema Viewer](./schema-viewer) - Interactive schema browser with LCR example
- [Download Schema](/schemas/morphir-ir-v3.json) - JSON format

## See Also

- [Global Schema Checker](/docs/tools/schema-checker) - Check all versions
- [Migration Guide](../../migration-guide) - Version migration
- [LCR Interactive](https://lcr-interactive.finos.org/) - Real-world example
