...
properties:
  formatVersion:
    anyOf:
      - const: 3
        description: "Canonical spelling of v3.0.0"
      - type: string
        pattern: "^3\\.(0|[1-9][0-9]*)\\.(0|[1-9][0-9]*)$"
        description: "Exact v3 release triplet"
    description: "The IR format version, governed by the v3-and-later formatVersion contract. Integer 3 is the canonical v3.0.0 baseline; exact release strings identify later revisions in the v3 family"
