---
title: "Schema Checker - Version 2"
sidebar_label: "Schema Checker"
sidebar_position: 2
description: "Validate Morphir IR JSON against the Version 2 schema"
---
...
# Morphir IR Schema Checker - Version 2

Validate your Morphir IR JSON against the **Version 2 (Legacy)** schema. Version 2 is a transitional format with capitalized tags for distributions.
...
export const SchemaChecker = () => {
  ...
  React.useEffect(() => {
    fetch('/schemas/morphir-ir-v2.json')
  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: '1rem' }}>
        ...
        >
          {isValidating ? 'Validating...' : 'Validate against V2 Schema'}
        </button>
      </div>
        ...
        <div>
          {validationResult.valid ? (
            <div className="alert alert--success" style={{ marginBottom: '1rem' }}>
              <strong>Valid!</strong> Your JSON conforms to the Morphir IR v2 schema.
            </div>
          ) : (
...
Version 2 is a **transitional format** between v1 and v3:

- **Distribution tags**: Capitalized (`Library` instead of `library`)
- **Type/Value tags**: Still lowercase in some contexts

## Schema Reference

- [Schema Viewer](./schema-viewer) - Interactive schema browser
- [Download Schema](/schemas/morphir-ir-v2.json) - JSON format
