...
The Morphir IR JSON schemas are available in both YAML and JSON formats:
...
For complete schema documentation, see the [Morphir IR JSON Schemas docs](/docs/spec/ir/schemas/).

For validation examples and usage, see the [Morphir IR Specification](/docs/spec/ir/morphir-ir-specification/).
