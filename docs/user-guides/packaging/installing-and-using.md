...
These commands target **Morphir CLI v0.4.0-beta.4**. Packaging commands and formats
...
Install [v0.4.0-beta.4](https://github.com/finos/morphir/releases/tag/v0.4.0-beta.4)
...
```sh
git clone --depth 1 --branch v0.4.0-beta.4 https://github.com/finos/morphir.git morphir-package-examples
...
[scoped-update example](https://github.com/finos/morphir/tree/v0.4.0-beta.4/examples/package/local-library-update)
