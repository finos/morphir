...
These commands target **Morphir CLI v0.4.0-beta.8**. Packaging commands and formats
...
Install [v0.4.0-beta.8](https://github.com/finos/morphir/releases/tag/v0.4.0-beta.8)
...
[scoped-update example](https://github.com/finos/morphir/tree/v0.4.0-beta.8/examples/package/local-library-update)
