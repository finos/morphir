...
These commands target **Morphir CLI v0.4.0-beta.5**. Packaging commands and formats
...
Install [v0.4.0-beta.5](https://github.com/finos/morphir/releases/tag/v0.4.0-beta.5)
...
[scoped-update example](https://github.com/finos/morphir/tree/v0.4.0-beta.5/examples/package/local-library-update)
