...
:::note Early access
The "today" column below describes **Morphir CLI v0.4.0-beta.9**. The target
...
[trust profile](https://github.com/finos/morphir/blob/v0.4.0-beta.9/spec/package/package-trust-profile.md)
