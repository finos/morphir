...
These guides describe **Morphir CLI v0.4.0-beta.8**. Packaging is an early-access
...
[v0.4.0-beta.8 release](https://github.com/finos/morphir/releases/tag/v0.4.0-beta.8),
