...
The [versioned example](https://github.com/finos/morphir/tree/v0.4.0-beta.9/examples/package/local-library-restore)
...
The [local Library contract](https://github.com/finos/morphir/blob/v0.4.0-beta.9/spec/package/local-library-contract.md)
and [trust profile](https://github.com/finos/morphir/blob/v0.4.0-beta.9/spec/package/package-trust-profile.md)
