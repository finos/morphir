 ...
 * - https://github.com/typelevel/Laika/blob/f282e9fa54cfe81329c9934310c5ab848bde0bae/core/shared/src/main/scala/laika/ast/ElementTraversal.scala
 *
...
/** Provides means to traverse and select elements of a document tree. This trait can get mixed in by any element node,
  * not just the root Document class, therefore providing traversal for any kind of sub-tree, too.
  *
  * @author
  *   Jens Halm
  */
trait ElementTraversal { this: Element =>
  ...
  /** Invokes the specified function for each child of this element container, including children of children, and this
    * element itself, in depth-first traversal.
    */
  ...
  /** Selects all elements satisfying the specified predicate, collecting in depth-first traversal, including this
    * element itself.
    */
  ...
  /** Collects elements by applying the partial function to all elements it is defined for, in depth-first traversal,
