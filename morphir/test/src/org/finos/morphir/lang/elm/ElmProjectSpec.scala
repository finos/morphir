...
object ElmPackageVersionSpec extends MorphirKyoSpecDefault:
  import ElmPackageVersion.given

  def spec = suite("ElmPackageVersionSpec")(
    test("should be able to parse from json") {
...
object ElmApplicationDependenciesSpec extends MorphirKyoSpecDefault:
  import ElmApplicationDependencies.given

  def spec = suite("ElmApplicationDependenciesSpec")(
