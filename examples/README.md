...
| [Installed Avro backend](backends/avro/scenarios.md) | Local bundle publication/installation, native Elm to default v4, Avro record and primitive field mappings, task provenance and installed output | Pinned Avro 0.2.0 WASM bundle |
| [Installed OpenAPI backend](backends/openapi/scenarios.md) | Local bundle publication/installation, native Elm to default v4, JSON Schema and OpenAPI schema components, task provenance and installed outputs | Pinned OpenAPI 0.2.0 WASM bundle |
