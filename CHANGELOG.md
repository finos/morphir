...
### Changed
- Update `morphir-rust` to `736fbdf`, bringing in the Rust Python frontend/backend for ADTs, fixed tuples and conditional function bodies, plus core IR model alignment and arbitrary-precision numeric literals (finos/morphir-rust#155, #156, #157). The Python extension is built and installed separately.
