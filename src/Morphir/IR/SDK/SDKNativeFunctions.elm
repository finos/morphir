...
nativeFunctions =
    ...
    , ( "Basics", "ceiling", eval1 Basics.ceiling (decodeLiteral floatLiteral) (encodeLiteral IntLiteral) )
    ...
    , ( "Basics", "floor", eval1 Basics.floor (decodeLiteral floatLiteral) (encodeLiteral IntLiteral) )
    ...
    , ( "Basics", "integerDivide", eval2 (//) (decodeLiteral intLiteral) (decodeLiteral intLiteral) (encodeLiteral IntLiteral) )
    ...
    , ( "Basics", "modBy", eval2 Basics.modBy (decodeLiteral intLiteral) (decodeLiteral intLiteral) (encodeLiteral IntLiteral) )
    ...
    , ( "Basics", "remainderBy", eval2 Basics.remainderBy (decodeLiteral intLiteral) (decodeLiteral intLiteral) (encodeLiteral IntLiteral) )
    , ( "Basics", "round", eval1 Basics.round (decodeLiteral floatLiteral) (encodeLiteral IntLiteral) )
    ...
    , ( "Basics", "truncate", eval1 Basics.truncate (decodeLiteral floatLiteral) (encodeLiteral IntLiteral) )
    ...
    , ( "Char", "toCode", eval1 Char.toCode (decodeLiteral charLiteral) (encodeLiteral IntLiteral) )
    ...
    , ( "List", "range", eval2 List.range (decodeLiteral intLiteral) (decodeLiteral intLiteral) (encodeList (encodeLiteral IntLiteral)) )
    ...
    , ( "String", "indexes", eval2 String.indexes (decodeLiteral stringLiteral) (decodeLiteral stringLiteral) (encodeList (encodeLiteral IntLiteral)) )
    , ( "String", "indices", eval2 String.indices (decodeLiteral stringLiteral) (decodeLiteral stringLiteral) (encodeList (encodeLiteral IntLiteral)) )
    ...
    , ( "String", "length", eval1 String.length (decodeLiteral stringLiteral) (encodeLiteral IntLiteral) )
    ...
    , ( "String", "toInt", eval1 String.toInt (decodeLiteral stringLiteral) (encodeMaybe (encodeLiteral IntLiteral)) )
