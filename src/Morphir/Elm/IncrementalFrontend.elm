...
-- convert exposedMod to List
-- foreach of exposedMod
-- convert exposed module to Name (List String)
-- check if name is a member of the parsed module imports ( list string)
-- if yes
-- foreach of parsedModule
-- get its imports
-- foreach imports extract .moduleName
--
