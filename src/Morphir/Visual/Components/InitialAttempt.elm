...
--    , branches : List ( Node )
--    --- , branches : List ( Pattern(), Node )  EXPLAIN WHAT THIS MEANS
--    -- list of tuples --> ()
--    -- care about order
--    }
--
...
--                [ 10 |> Border.width
--                , Border.rounded 6
--                , Border.color (Color 20 20 20 |> toElementColor)
--                , mediumPadding config.state.theme |> padding
--                ]
--                (viewValue value)
--
...
--------
--
--verticalLayout : Config msg -> Element msg -> Element msg -> List (Element msg )-> Element msg
--verticalLayout config condition branch1Label branches  =
--    column
--        []
--        [ row []
--            [ column
...
----            , ( Value.WildcardPattern (), Branch (Value.Variable ( 0, Type.Unit () ) [ "foo" ]) )
...
----            , ( Value.WildcardPattern (), Leaf (Value.Variable ( 0, Type.Unit () ) [ "foo" ]) )
----            , ( Value.WildcardPattern (), Leaf (Value.Variable ( 0, Type.Unit () ) [ "foo" ]) ),
-----             ( Value.LiteralPattern() (BoolLiteral True), Leaf (Value.Variable ( 0, Type.Unit () ) [ "foo" ]) )
----            ]
----        }
--ifThen =
--    if a then
...
--pattern a =
--    case a of
--        -- LitearllPattern boolliterl true
--        True ->
--            1 -- False --> boolliteral False
--        False ->
--            2
--
--
------ QUESTIONS
---- explain the parameters of Pattern
---- also explain the
--
