...
const cases = [
  ...
  ['project extras', { project: { name: 'acme/orders', description: 'Orders', authors: ['Alice'], license: 'Apache-2.0', repository: 'https://example.com/r' } }, true],
  ['workspace out_dir', { workspace: { out_dir: 'build/out' } }, true],
  ['workspace out_dir wrong type', { workspace: { out_dir: 3 } }, false],
  ['ir layout and format', { ir: { layout: 'document-tree', format: 'yaml' } }, true],
  ['ir unknown layout', { ir: { layout: 'vfs' } }, false],
  ['ir unknown format', { ir: { format: 'toml' } }, false],
